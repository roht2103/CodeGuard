...
export function Button({
  ...
  const variants = {
    ...
    secondary:
      "bg-gray-100 text-gray-900 hover:bg-gray-200 dark:bg-gray-900 dark:text-gray-100 dark:hover:bg-gray-800 border border-transparent dark:border-gray-800",
    outline:
      "border border-gray-200 bg-transparent text-gray-700 hover:bg-gray-50 dark:border-gray-800 dark:text-gray-300 dark:hover:bg-black",
    ghost:
      "bg-transparent text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-900",
  };
